 ...
 */
public class mMaterialLargeImageCard extends BaseMaterialCard {
    ...
    public mMaterialLargeImageCard(Context context) {
        this(context, it.gmariotti.cardslib.library.cards.R.layout.native_material_largeimage_inner_base_main);
    }

    public mMaterialLargeImageCard(Context context, @LayoutRes int innerLayout) {
    ...
    public static final class SetupWizard {
        ...
        public mMaterialLargeImageCard build() {
            return build(new mMaterialLargeImageCard(mContext));
        }

        public mMaterialLargeImageCard build(mMaterialLargeImageCard card) {
