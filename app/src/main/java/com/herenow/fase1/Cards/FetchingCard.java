...
public class FetchingCard extends CardWithList implements OnTaskCompleted {

    private String mUrl, mTitle;
    private ArrayList<ListObject> mElementsToShow;
    private cardLoadedListener listener;

    public FetchingCard(Context context, String url, String title) {
        super(context);
        mUrl = url;
        mTitle = title;
    }
    ...
    class FetchUrl extends AsyncTask<String, Void, ArrayList<Employee>> {
