...
/**
 * Created by Milenko on 13/10/2015.
 */

public class CardViewNative2 extends android.support.v7.widget.CardView implements CardViewWrapper {
    ...
    protected
    @LayoutRes
    int card_layout_resourceID = it.gmariotti.cardslib.library.R.layout.native_card_layout;
    ...
    public CardViewNative2(int cardLayoutResId, Context context) {
        this(cardLayoutResId, context, null, 0);
    }

    public CardViewNative2(int cardLayoutResId, Context context, AttributeSet attrs) {
        this(cardLayoutResId, context, attrs, 0);
    }

    public CardViewNative2(int cardLayoutResId, Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        card_layout_resourceID = cardLayoutResId;
        init(attrs, defStyleAttr);

        mHelperImpl = CardViewHelperUtil.getInstance(context);
    }

    public CardViewNative2(Context context, @LayoutRes int cardLayoutResId) {
        this(cardLayoutResId, context);
...
//        card_layout_resourceID = it.gmariotti.cardslib.library.R.layout.native_card_layout;

//        TypedArray a = getContext().getTheme().obtainStyledAttributes(
//                attrs, it.gmariotti.cardslib.library.R.styleable.card_options, defStyle, defStyle);
//
//        try {
//            card_layout_resourceID = a.getResourceId(it.gmariotti.cardslib.library.R.styleable.card_options_card_layout_resourceID, this.card_layout_resourceID);
//        } finally {
//            a.recycle();
//        }
    }
    ...
    protected void initView() {
        ...
        //Radius
        setRadius(getResources().getDimension(it.gmariotti.cardslib.library.R.dimen.card_background_default_radius));
    ...
    protected void retrieveLayoutIDs() {
        ...
        //Main Layout
        mInternalMainCardLayout = (View) findViewById(it.gmariotti.cardslib.library.R.id.card_main_layout);

        //Get HeaderLayout
        mInternalHeaderLayout = (CardHeaderView) findViewById(it.gmariotti.cardslib.library.R.id.card_header_layout);

        //Get ExpandHiddenView
        mInternalExpandLayout = (View) findViewById(it.gmariotti.cardslib.library.R.id.card_content_expand_layout);

        //Get ContentLayout
        mInternalContentLayout = (View) findViewById(it.gmariotti.cardslib.library.R.id.card_main_content_layout);

        //Get ThumbnailLayout
        mInternalThumbnailLayout = (CardThumbnailView) findViewById(it.gmariotti.cardslib.library.R.id.card_thumbnail_layout);
    }
            ...
            mInternalExpandLayout.getViewTreeObserver().addOnPreDrawListener(
                    new ViewTreeObserver.OnPreDrawListener() {
                        ...
                        public boolean onPreDraw() {
                            ...
                            mExpandAnimator = ExpandCollapseHelper.createSlideAnimator((CardViewNative2) mCard.getCardView(), 0, mInternalExpandLayout.getMeasuredHeight());
                            return true;
                        }
                    });
        }
